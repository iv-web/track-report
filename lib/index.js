...
var BJ_REPORT = (function(global) {
    ...
    var _autoReportOffline = function (){
        ...
        script.src = _config.offline_auto_url || _config.url.replace(/badjs$/ , "badjs/offlineAuto") + "?id="+_config.id + "&uin="+_config.uin;
            ...
            Offline_DB.ready(function (err , DB){
                ...
                DB.getLogs( {
                    ...
                    iframe.onload = function (){
                        ...
                        form.method = "POST";
                        form.action = _config.offline_url || _config.url.replace(/badjs$/ , "badjs/offlineLog");
